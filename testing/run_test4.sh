#! /bin/bash
# "2bitcomp_5.cnf" "C215_FC.cnf" "par16-1-c.cnf" "qg7-09.cnf" "2bitmax_6.cnf"
# "C230_FR.cnf" "par16-2-c.cnf" "ra.cnf" "4blocksb.cnf"    "C250_FW.cnf" 
# "par16-2.cnf" "ssa7552-038.cnf" "ais10.cnf" "C638_FKA.cnf"  "par16-3.cnf"
files=( "tire-2.cnf" "bw_large.a.cnf" "C638_FVK.cnf" "par16-5-c.cnf" "tire-3.cnf" )
...
# "C210_FVF.cnf" "log-3.cnf" "qg3-08.cnf" "C211_FS.cnf" "medium.cnf" "qg6-09.cnf")
